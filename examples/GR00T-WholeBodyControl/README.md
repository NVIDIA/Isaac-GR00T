...
> **Note:** No pre-finetuned G1 checkpoint is available for N1.7. To run this example, finetune from the base model (`nvidia/GR00T-N1.7-3B`) using the instructions below. The N1.6 checkpoint (`nvidia/GR00T-N1.6-G1-PnPAppleToPlate`) is only compatible with the [n1.6-release](https://github.com/NVIDIA/Isaac-GR00T/tree/n1.6-release) branch.
