...
This builds from `nvidia/cuda:13.0.0-devel-ubuntu22.04` and installs the locked dependencies into `/opt/gr00t-venv`. The image does not include a working source checkout; for normal use, start the image and then clone or pull the repo you want to run inside the container.
