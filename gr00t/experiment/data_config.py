...
class G1UpperBodyDataConfig(BaseDataConfig):
    video_keys = ["video.cam_left_high","video.cam_right_high","video.cam_left_wrist","video.cam_right_wrist"]
    state_keys = [
        "state.left_arm",
        "state.right_arm",
        "state.left_hand",
...
class AlohaDataConfig(BaseDataConfig):
    video_keys = ["video.cam_left_wrist", "video.cam_mid_high", "video.cam_right_wrist"]
    state_keys = [
        "state.left_arm",
        "state.right_arm",
    ]
...
DATA_CONFIG_MAP = {
    ...
    "Single_Kinova": SingleKinovaDataConfig(),
    "g1_upperbody": G1UpperBodyDataConfig(),
