#!/bin/bash
# install_deps.sh — One-time install of GR00T deps on Jetson AGX Thor (aarch64, Python 3.10+)
...
if [ "$PYTHON_VERSION" != "3.12" ]; then
    echo "NOTE: Thor CI targets Python 3.12; detected Python $PYTHON_VERSION"
fi
